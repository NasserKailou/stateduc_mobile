<?php
	...
	$GLOBALS['PARAM']['TYPE_CHAINE_REGROUPEMENT']				=	'TYPE_CHAINE_LOC';
																						   
	$GLOBALS['PARAM']['HIERARCHIE']								=	'HIERARCHIE';
	$GLOBALS['PARAM']['NIVEAU_CHAINE']							=	'NIVEAU_HIERARCHIE';
    ...
    $GLOBALS['PARAM']['NOM_ETABLISSEMENT']	                    =	'NOM_ETABLISSEMENT';
     $GLOBALS['PARAM']['CODE_ADMINISTRATIF']	                    =	'CODE_ECOLE_PAYS';
	$GLOBALS['PARAM']['NOM_CHEF_ETABLISSEMENT']             	=	'NOM_CHEF_ETABLISSEMENT';
    $GLOBALS['PARAM']['TYPE_STATUT_ETABLISSEMENT']	            =	'TYPE_STATUT_ORG';
	...
	$GLOBALS['PARAM']['TYPE_SYSTEME_ENSEIGNEMENT']	            =	'TYPE_SECTEUR_ENS';
    
	$GLOBALS['PARAM']['TYPE_ANNEE']	                            =	'TYPE_ANNEE';
    
	$GLOBALS['PARAM']['ENSEIGNANT']	                            =	'LISTE_PERSONNEL';
	$GLOBALS['PARAM']['IDENTIFIANT_ENSEIGNANT']	                =	'ID_PERSONNEL';
	$GLOBALS['PARAM']['NUMERO_ORDRE_ENSEIGNANT']	            =	'';
	$GLOBALS['PARAM']['NOM_ENSEIGNANT']	                        =	'NOM_PERSONNEL';
	$GLOBALS['PARAM']['PRENOMS_ENSEIGNANT']	                    =	'PRENOM_PERSONNEL';
	$GLOBALS['PARAM']['MATRICULE_ENSEIGNANT']	                =	'NUMERO_MATRICULE';
	$GLOBALS['PARAM']['ENSEIGNANT_ETABLISSEMENT']	            =	'LISTE_PERSONNEL_ETABLISSEMENT';
	...
	$GLOBALS['PARAM']['CHAMPS_POPULATION'][]					=	array('NOM_CHAMP' => 'GARCONS' , 'LABEL_CHAMP' => 'G');
	$GLOBALS['PARAM']['CHAMPS_POPULATION'][]					=	array('NOM_CHAMP' => 'FILLES' , 'LABEL_CHAMP' => 'F');
