...
{
 global_pjsid=pjsid;
 var url = "http://localhost:9090/StatEduc_Madagascar_MEN_FRE/administration.php?val=feedbacks_auto_delete";
...
function modify(id)
{
  document.ff.action="http://localhost:9090/StatEduc_Madagascar_MEN_FRE/administration.php?val=feedbacks_auto_modify";
