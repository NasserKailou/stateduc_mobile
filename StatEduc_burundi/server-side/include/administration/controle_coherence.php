...
<script language="javascript" type="text/javascript">
	...
	$(document).bind("contextmenu",function(){
		alert("<?php if (recherche_libelle_page('ctrl_right_click') <> "") echo recherche_libelle_page('ctrl_right_click'); else echo "Please, don't open several tabs or windows in the same browser to perform data correction, you may overwrite your data in doing that!";?>");
...
<table class="center-table" width="98%" style="height:550px">
	<caption><?php echo recherche_libelle_page('CaptionCtrl'); ?></caption>
  <tr>
    <td>
		<!--debut config criteres ctrl -->
		<?php require $GLOBALS['SISED_PATH_INC'] . 'administration/ctrl_coherence_criteres.php';
		?>
...
<?php if( $do_action_post == true ){
		...
		//echo '<br> nb_etabs = '.count($tab_etabs_run).'<br>';
		//echo'<pre>';
		//print_r($tab_ctrls_run);
