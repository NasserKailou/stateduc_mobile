<script language="JavaScript1.2" type="text/javascript">
    ...
    function recharger() {
		location.href   = 'synthese.php?val=OpenPopupExportHtml';
	}
    
    function OpenPopupExportHtml() {
		var	popup	=	window.open('synthese.php?val=videForXls','PopupExportXls', 'toolbar=yes,location=yes,directories=no,menubar=yes,scrollbars=yes,status=yes,resizable=1,width=800, height=400, left=225, top=150')
        popup.document.close();
        var chaine_eval = "popup.window.location.href   = 'synthese.php?val=OpenPopupExportHtml';";
        eval(chaine_eval);
        popup.focus();
    }		
</script>
