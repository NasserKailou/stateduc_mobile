<?php $requete      = ' SELECT DICO_REPORT.LIBELLE_REPORT
    ...
    $req_tabm               = ' SELECT DICO_RPT_TABLE_MERE.ID_RPT_TABLE_MERE, 
    ...
    if( isset($val['ID_TABLE']) && (trim($val['ID_TABLE']) <> '')){
        $requete                = ' SELECT DICO_RPT_CHAMP.ID_CHAMP, DICO_RPT_CHAMP.ID_RPT_TABLE_MERE, DICO_RPT_CHAMP.NOM_CHAMP, DICO_RPT_CHAMP.ALIAS
                                    FROM DICO_RPT_CHAMP
                                    WHERE DICO_RPT_CHAMP.ID = '.$_GET['id'].' AND DICO_RPT_CHAMP.ID_RPT_TABLE_MERE='.$val['ID_TABLE'].';';
...
<table align="center" border="1" width="400">
	...
	<tr> 
      ...
      <td width="70%"><INPUT style="width : 95%;" readonly="1" type="text" size="3" name="ID_CRITERE" value="<?php echo $val['ID_CRITERE']; ?>"></td>
    </tr>
	<tr> 
    ...
    <td width="70%">	  
	  <select style="width : 100%;" name="ID_TABLE" onchange="set_tabm_things(this.value)">
                ...
                foreach ($res_tabm as $i => $tabm ){
					...
					if ( trim($tabm['ID_RPT_TABLE_MERE']) == trim($val['ID_TABLE'])){
						echo " selected";
	...
	<tr> 
      ...
      <td width="70%"><INPUT style="width : 95%;" type="text" size="20" id="ALIAS_TABLE" name="ALIAS_TABLE" value="<?php echo $val['ALIAS_TABLE']; ?>" readonly="1"></td>
    </tr>
    <tr> 
	...
	<tr> 
      ...
      <td width="70%">
	  <INPUT style="width : 88%;" type="text" size="20" name="VALEUR" value="<?php echo $val['VALEUR']; ?>">
      <input name="button" type="button" style="width:10%;" onclick="OpenPopupRptCritValue(<?php echo '\''.$_GET['id'].'\''; ?>,NOM_TABLE.value,NOM_CHAMP.value,VALEUR.value)" value="..." />
      </td>
    </tr>
