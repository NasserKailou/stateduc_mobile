...
<?php //$GLOBALS['PARAM']['']
		...
		$champs[] = array('nom'=>'NOM_FONCTIONNALITE_SYSTEME', 'type'=>'text', 'cle'=>'', 'incr'=>'', 'val'=>'', 'lib'=>'fonc_sys', 'obli'=>'1', 'filtre'=>'', 'ordre'=>'');
		$champs[] = array('nom'=>'ACTIVER', 'type'=>'int', 'cle'=>'', 'incr'=>'', 'val'=>'', 'lib'=>'activer', 'obli'=>'', 'filtre'=>'', 'ordre'=>'');
		

		$table->table				= 'DICO_FONCTIONNALITE_SYSTEME';
		$table->champs 				= $champs;
		$table->nom_champ_combo		= 'NOM_FONCTIONNALITE_SYSTEME';
		$table->frame				= $GLOBALS['SISED_PATH_INC'] . 'annuaire/frame_gestion_fonc_syst.php';
		$table->taille_ecran		= '500';
		$table->taille_combo		= '150';
		$table->btn_quit			= true;
		$table->titre_ecran			= 'GesFoncSys';
