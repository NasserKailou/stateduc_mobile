...
<?php //$GLOBALS['PARAM']['']
		...
		$champs[] = array('nom'=>'NOM_RUBRIQUE_SYSTEME', 'type'=>'text', 'cle'=>'', 'incr'=>'', 'val'=>'', 'lib'=>'rub_sys', 'obli'=>'1', 'filtre'=>'', 'ordre'=>'');
		$champs[] = array('nom'=>'ACTIVER', 'type'=>'int', 'cle'=>'', 'incr'=>'', 'val'=>'', 'lib'=>'activer', 'obli'=>'', 'filtre'=>'', 'ordre'=>'');
		

		$table->table				= 'DICO_RUBRIQUE_SYSTEME';
		$table->champs 				= $champs;
		$table->nom_champ_combo		= 'NOM_RUBRIQUE_SYSTEME';
		$table->frame				= $GLOBALS['SISED_PATH_INC'] . 'annuaire/frame_gestion_rub_syst.php';
		$table->taille_ecran		= '500';
		$table->taille_combo		= '150';
		$table->btn_quit			= true;
		$table->titre_ecran			= 'GesRubSys';
