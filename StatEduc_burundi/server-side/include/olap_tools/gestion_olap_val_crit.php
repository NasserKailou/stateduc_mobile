...
<table align="center" border="1" width="450">
	...
	<tr><td colspan="2">
        <table width="100%">
				...
				?>
					<tr> 
							<td><INPUT style="width:100%" type='text' name="<?php echo'CHP_'.$i;?>" value="<?php echo $chp[$nom_chp];?>" readonly="1"></td>
							<td align="center"><INPUT type="checkbox" name="<?php echo'IMPORT_CHP_'.$i;?>"   value="<?php echo $chp[$nom_chp] ?>" <?php echo $checked; ?>></td>
					</tr>
				<?php }
				?>
