<?php $all_op		= array(  
	...
	$requete                = ' SELECT DICO_OLAP.THEME_NAME
								FROM DICO_OLAP
...
<tr> 
        <td width="60%"><select style="width : 100%;" name="ID_OLAP_TABLE_MERE_1" onchange="set_options_tabm('ID_OLAP_TABLE_MERE_2', this.value, ID_OLAP_TABLE_MERE_2.value);set_options_chp('ID_CHAMP_1',this.value,'')">
        </select></td>
	...
	<tr> 
        <td width="60%"><select style="width : 100%;" name="ID_OLAP_TABLE_MERE_2"  onchange="set_options_tabm('ID_OLAP_TABLE_MERE_1', this.value, ID_OLAP_TABLE_MERE_1.value);set_options_chp('ID_CHAMP_2',this.value,'')">
...
echo '
	<script language="javascript" type="text/javascript">
		set_options_tabm (\'ID_OLAP_TABLE_MERE_1\', document.Formulaire.ID_OLAP_TABLE_MERE_2.value, \'\');
		set_options_tabm (\'ID_OLAP_TABLE_MERE_2\', document.Formulaire.ID_OLAP_TABLE_MERE_1.value, \'\' );
		set_options_chp (\'ID_CHAMP_1\',document.Formulaire.ID_OLAP_TABLE_MERE_1.value, \'\');
		set_options_chp (\'ID_CHAMP_2\',document.Formulaire.ID_OLAP_TABLE_MERE_2.value, \'\');
...
echo '
	<script language="javascript" type="text/javascript">
		set_options_tabm (\'ID_OLAP_TABLE_MERE_1\', \''.$val['ID_OLAP_TABLE_MERE_2'].'\', \''.$val['ID_OLAP_TABLE_MERE_1'].'\');
		set_options_tabm (\'ID_OLAP_TABLE_MERE_2\', \''.$val['ID_OLAP_TABLE_MERE_1'].'\', \''.$val['ID_OLAP_TABLE_MERE_2'].'\');
		set_options_chp (\'ID_CHAMP_1\', \''.$val['ID_OLAP_TABLE_MERE_1'].'\', \''.$val['ID_CHAMP_1'].'\');
		set_options_chp (\'ID_CHAMP_2\', \''.$val['ID_OLAP_TABLE_MERE_2'].'\', \''.$val['ID_CHAMP_2'].'\');
	</script>';
?>
