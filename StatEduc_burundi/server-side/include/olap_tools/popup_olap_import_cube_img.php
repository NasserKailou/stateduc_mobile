<?php lit_libelles_page('/popup_olap_import_cube_img.php');
set_time_limit(0);
ini_set('memory_limit',113246208);	
if($_FILES['file']) {	
	echo "<br /><br /><br />";	
	$rep = "server-side/include/olap_tools/images/"; 	
	...
	if(!empty($fichier["name"]))
	{
		...
		if(copy($nomTemporaire, $saveFile)){
			...
			echo '<script type="text/Javascript">
					parent.document.Formulaire.ASSOCIATE_IMAGE_FILE.value=\''.$nomFichier.'\';
					fermer();
				  </script>';
		}
		else
...
<form action="<?php echo $PHP_SELF; ?>" method="post" enctype="multipart/form-data">
	<table border="1" align="center" width="400">
		<caption><b><?php echo recherche_libelle_page('LibImportImg'); ?></b></caption>
		<tr> 
		  <td align="center">
