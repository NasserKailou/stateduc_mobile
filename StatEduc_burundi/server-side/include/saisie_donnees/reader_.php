    ...
    */
        ...
        if($res === false) {
            ...
            // bad file
				...
				print "alert('The filename : ". $sFileName ."  is not readable');\n";
				print "fermer();\n";
				print "</script>\n";
...
//                                              echo "Str $i = $retstr\n";
                ...
                case SPREADSHEET_EXCEL_READER_TYPE_BOUNDSHEET:
                    ...
                    if(strtoupper(substr($rec_name,0,5))<>"ANNEX")
...
//            $r = &$this->file->nextRecord();
    ...
    function createDate($numValue)
    {
		...
		//echo "numValue : $numValue ; date : $string ; curformat : $this->curformat <br/>";
