...
oCMenu.makeMenu('2404','1030','Identification & Localisation','questionnaire.php?theme=2404','','200');
oCMenu.makeMenu('2504','1030','Informations Générales','questionnaire.php?theme=2504','','200');
oCMenu.makeMenu('6804','1030','Salles de classe & Mobiliers','questionnaire.php?theme=6804','','200');
oCMenu.makeMenu('7004','1030','Equipements','questionnaire.php?theme=7004','','200');
oCMenu.makeMenu('7104','1030','Effectif des élèves et Red','questionnaire.php?theme=7104','','200');
oCMenu.makeMenu('2804','1030','Effectif des élèves par âge','questionnaire.php?theme=2804','','200');
oCMenu.makeMenu('8304','1030','Résultats aux examens(1)','questionnaire.php?theme=8304','','200');
oCMenu.makeMenu('6904','1030','Résultats aux examens(2)','questionnaire.php?theme=6904','','200');
oCMenu.makeMenu('7204','1030','Elèves internes','questionnaire.php?theme=7204','','200');
oCMenu.makeMenu('8404','1030','TechA2 Données financières','questionnaire.php?theme=8404','','200');
oCMenu.makeMenu('2904','1030','Infos sur le personnel(1)','questionnaire.php?theme=2904','','200');
oCMenu.makeMenu('3004','1030','Infos sur le personnel(2)','questionnaire.php?theme=3004','','200');
oCMenu.makeMenu('7904','1030','Liste personnel','questionnaire.php?theme=7904','','200');
