//Menu object creation
            ...
            oCMenu.level[3]=new cm_makeLevel(140,22);oCMenu.fromLeft=386;
...
oCMenu.makeMenu('24','30030','Etablissements','#','','270');
oCMenu.makeMenu('64','24','Nombre Etablissements par statut','synthese.php?val=list_rpt&id_rpt=6&type_rpt=1&id_syst=4','','270');
oCMenu.makeMenu('84','24','Salles de classes par statut Etab','synthese.php?val=list_rpt&id_rpt=8&type_rpt=1&id_syst=4','','270');
oCMenu.makeMenu('14','30030','Eleves','#','','270');
oCMenu.makeMenu('94','14','Redoublands par niveau secondaire','synthese.php?val=list_rpt&id_rpt=9&type_rpt=1&id_syst=4','','270');
oCMenu.makeMenu('54','14','Effectifs par age secondaire','synthese.php?val=list_rpt&id_rpt=5&type_rpt=1&id_syst=4','','270');
oCMenu.makeMenu('34','30030','Enseignants','synthese.php?val=list_rpt&id_rpt=3&type_rpt=&id_syst=4','','270');
