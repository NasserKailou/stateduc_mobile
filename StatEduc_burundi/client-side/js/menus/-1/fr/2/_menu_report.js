...
oCMenu.makeMenu('22','30030','Etablissements','#','','270');
oCMenu.makeMenu('62','22','Nombre Etablissements','synthese.php?val=list_rpt&id_rpt=6&type_rpt=1&id_syst=2','','270');
oCMenu.makeMenu('82','22','Salles de classes par statut Etab','synthese.php?val=list_rpt&id_rpt=8&type_rpt=1&id_syst=2','','270');
oCMenu.makeMenu('12','30030','Eleves','#','','270');
oCMenu.makeMenu('42','12','Effectifs par age et par niveau','synthese.php?val=list_rpt&id_rpt=4&type_rpt=5&id_syst=2','','270');
oCMenu.makeMenu('72','12','Redoublants par niveau','synthese.php?val=list_rpt&id_rpt=7&type_rpt=1&id_syst=2','','270');
oCMenu.makeMenu('32','30030','Enseignants','synthese.php?val=list_rpt&id_rpt=3&type_rpt=&id_syst=2','','270');
