...
oCMenu.makeMenu('23','30030','Etablissements','#','','270');
oCMenu.makeMenu('63','23','Nombre Etablissements par statut','synthese.php?val=list_rpt&id_rpt=6&type_rpt=1&id_syst=3','','270');
oCMenu.makeMenu('83','23','Salles de classes par statut Etab','synthese.php?val=list_rpt&id_rpt=8&type_rpt=1&id_syst=3','','270');
oCMenu.makeMenu('13','30030','Eleves','#','','270');
oCMenu.makeMenu('53','13','Effectifs par age secondaire','synthese.php?val=list_rpt&id_rpt=5&type_rpt=1&id_syst=3','','270');
oCMenu.makeMenu('93','13','Redoublands par niveau secondaire','synthese.php?val=list_rpt&id_rpt=9&type_rpt=1&id_syst=3','','270');
oCMenu.makeMenu('33','30030','Enseignants','synthese.php?val=list_rpt&id_rpt=3&type_rpt=&id_syst=3','','270');
