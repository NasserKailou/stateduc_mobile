...
oCMenu.makeMenu('101','1030','Identification & Localisation','questionnaire.php?theme=101','','200');
oCMenu.makeMenu('201','1030','Donn̩es G̩n̩rales','questionnaire.php?theme=201','','200');
oCMenu.makeMenu('401','1030','Mobiliers & Equipements','questionnaire.php?theme=401','','200');
oCMenu.makeMenu('501','1030','Infos relatives aux enfants','questionnaire.php?theme=501','','200');
oCMenu.makeMenu('8201','1030','Protection des enfants et donnees financieres presco','questionnaire.php?theme=8201','','200');
oCMenu.makeMenu('601','1030','Infos sur le personnel','questionnaire.php?theme=601','','200');
oCMenu.makeMenu('7601','1030','Liste Personnel','questionnaire.php?theme=7601','','200');
