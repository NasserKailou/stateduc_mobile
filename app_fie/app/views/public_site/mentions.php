...
if ('mentions' == 'aide') echo 'Aide et documentation';
elseif ('mentions' == 'contact') echo 'Contact';
elseif ('mentions' == 'confidentialite') echo 'Politique de confidentialité';
else echo 'Mentions légales';
?></h1></div>
<div class="fie-card">
<?php if ('mentions' == 'confidentialite' || 'mentions' == 'mentions'): ?>
