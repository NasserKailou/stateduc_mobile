...
if ('contact' == 'aide') echo 'Aide et documentation';
elseif ('contact' == 'contact') echo 'Contact';
elseif ('contact' == 'confidentialite') echo 'Politique de confidentialité';
else echo 'Mentions légales';
?></h1></div>
<div class="fie-card">
<?php if ('contact' == 'confidentialite' || 'contact' == 'mentions'): ?>
