...
if ('confidentialite' == 'aide') echo 'Aide et documentation';
elseif ('confidentialite' == 'contact') echo 'Contact';
elseif ('confidentialite' == 'confidentialite') echo 'Politique de confidentialité';
else echo 'Mentions légales';
?></h1></div>
<div class="fie-card">
<?php if ('confidentialite' == 'confidentialite' || 'confidentialite' == 'mentions'): ?>
...
<?php elseif ('confidentialite' == 'contact'): ?>
